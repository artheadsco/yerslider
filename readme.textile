...
h3. <span style="text-decoration: line-through;">Time for fading slides in on sliderload</span>

<pre><code><span style="text-decoration: line-through;">showslidestime: 1000,</span></code></pre>
...
<pre><code><li class="yerslider-slide js media">
